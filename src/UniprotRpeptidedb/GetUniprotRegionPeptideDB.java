 ...
 * @author julieklein
 */
public class GetUniprotRegionPeptideDB {

    public GetUniprotRegionPeptideDB() {
        PrintStream csvWriter = null;
        try {
            //CREATE THE BIG RESULT TABLE
            LinkedList<RpeptideDBEntry> alldata = new LinkedList<RpeptideDBEntry>();
            //RETRIEVE XML
            ...
            String xpathQuery = "/uniprot/entry[./feature[@type='domain']|./feature[@type='region of interest']|./feature[@type='short sequence motif']]";
            ...
            String xpathQueryNode2 = "./feature[@type='domain']|./feature[@type='region of interest']|./feature[@type='short sequence motif']";
            ...
            for (int i = 0; i < getNodeListbyXPath.getLength(); i++) {
                ...
                ProteinDBEntryR pdb = new ProteinDBEntryR();
                ...
                for (int j = 0; j < getNodeListByXPathNoder2.getLength(); j++) {
                    ...
                    RpeptideDBEntry rdb = new RpeptideDBEntry();
                    ...
                    if (stringfromNodelist21.isEmpty()) {
                        ...
                        rdb.setrdescription(stringz);
                        rdb.setProtein(pdb);
                        System.out.println(stringz);
                    }
                    else{
                    String string21 = stringfromNodelist21.getFirst();
                    rdb.setrdescription(string21);
                    rdb.setProtein(pdb);
            ...
            System.out.println("-----------------");
            csvWriter = new PrintStream("RDB.csv");
            ...
            csvWriter.print(",");
            csvWriter.print("R Peptide description");
            csvWriter.print(",");
            csvWriter.print("R Peptide start");
            csvWriter.print(",");
            csvWriter.print("R Peptide end");
            csvWriter.print(",");
            csvWriter.print("R Peptide sequence");
            csvWriter.print(",");
            csvWriter.print("url");
            csvWriter.print("\n");
            for (RpeptideDBEntry RpeptideDBEntry : alldata) {
                System.out.println(RpeptideDBEntry);
                csvWriter.print(RpeptideDBEntry.protein.getProteinname());
                csvWriter.print(",");
                //            csvWriter.print(RpeptideDBEntry.protein.getProteinacessionlist());
                //            csvWriter.print(",");
                csvWriter.print(RpeptideDBEntry.protein.getProteinsequence());
                csvWriter.print(",");
                csvWriter.print(RpeptideDBEntry.protein.getProteintaxonomy());
                csvWriter.print(",");
                csvWriter.print(RpeptideDBEntry.getrdescription());
                csvWriter.print(",");
                csvWriter.print(RpeptideDBEntry.getrP1());
                csvWriter.print(",");
                csvWriter.print(RpeptideDBEntry.getrP1prime());
                csvWriter.print(",");
                csvWriter.print(RpeptideDBEntry.getrsequence());
                csvWriter.print(",");
                csvWriter.print(RpeptideDBEntry.protein.getProteinurl());
                csvWriter.print("\n");

            }
        } catch (FileNotFoundException ex) {
            Logger.getLogger(GetUniprotRegionPeptideDB.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            csvWriter.close();
        }
    }
    ...
    public static void main(String[] args) {
        GetUniprotRegionPeptideDB JulieUniprot = new GetUniprotRegionPeptideDB();
